...
const QUERY = Has.Move | 16 /* PlayerControl */;
const AXIS_X = [1, 0, 0];
const AXIS_Y = [0, 1, 0];
export function sys_control_player(game, delta) {
...
function update(game, entity, delta) {
    let control = game[4 /* PlayerControl */][entity];
    if (control.Move) {
...
//# sourceMappingURL=sys_control_player.js.map