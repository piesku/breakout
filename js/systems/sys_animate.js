import { Anim, AnimationFlag } from "../components/com_animate.js";
import { slerp } from "../math/quat.js";
import { lerp } from "../math/vec3.js";
const QUERY = 16384 /* Transform */ | 1 /* Animate */;
export function sys_animate(game, delta) {
...
function update(game, entity, delta) {
    ...
    let animate = game[0 /* Animate */][entity];
...
//# sourceMappingURL=sys_animate.js.map