...
const QUERY = 16384 /* Transform */ | 128 /* Mimic */;
export function sys_mimic(game, delta) {
    for (let i = 0; i < game.World.length; i++) {
        if ((game.World[i] & QUERY) === QUERY) {
            let follower_transform = game[14 /* Transform */][i];
            let follower_mimic = game[7 /* Mimic */][i];
            let target_transform = game[14 /* Transform */][follower_mimic.target];
...
//# sourceMappingURL=sys_mimic.js.map